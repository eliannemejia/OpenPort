...
with center:
    ...
    st.markdown("<h1 style='text-align: center;'>About OPENPORT</h1>", unsafe_allow_html=True)

st.markdown(
    """
    In a world increasingly torn by conflict, OPENPORT is a digital lifeline for those navigating the asylum process. 
    ...
    Legal professionals can identify where their impact will be greatest. OPENPORT turns complex, fragmented asylum systems into a guided, informed journey toward safety and support.
    """
)
